...
window.onclick = (event) => {
    if (event.target === document.getElementById("addendumModal")) {
        document.getElementById("addendumModal").style.display = "none";
    } else if (event.target === document.getElementById("technicalAddendumModal")) {
        document.getElementById("technicalAddendumModal").style.display = "none";
    }
};
